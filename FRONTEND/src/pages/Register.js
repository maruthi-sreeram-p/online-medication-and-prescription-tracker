...
import {
  ...
  Business, History, LocalHospital, Badge, Groups, AccessTime,
  AdminPanelSettings
...
const Register = () => {
  ...
  const handleRegister = async (e) => {
    ...
    const requestData = {
      ...
      hospitalName: role === 'staff' ? formData.staffHospitalName : formData.hospitalName,
        ...
        <Card sx={{ p: { xs: 3, md: 5 }, borderRadius: 6, boxShadow: '0 20px 40px rgba(0,0,0,0.08)' }}>
          ...
          <Box sx={{ display: 'flex', justifyContent: 'center', mb: 4 }}>
            ...
            >
              ...
              <ToggleButton value="staff" sx={{ fontWeight: 700 }}>
                <Groups sx={{ mr: 1 }} /> Staff
              </ToggleButton>
              <ToggleButton value="admin" sx={{ fontWeight: 700 }}>
          ...
          <form onSubmit={handleRegister}>
            ...
            {/* Core Identity — Common for all roles */}
              ...
              <Box>
                ...
                <Grid container spacing={2}>
                  ...
                  <Grid item xs={12} md={4}>
                    <TextField
                      fullWidth label="Years of Experience" name="experienceYears"
                      type="number" onChange={handleChange}
                      InputProps={{
                        startAdornment: (
                          <InputAdornment position="start"><History fontSize="small" /></InputAdornment>
                        )
                      }}
                    />
                  </Grid>
                  ...
                  <Grid item xs={12}>
                    <TextField
                      fullWidth label="Hospital Address" name="hospitalAddress"
                      multiline rows={2} onChange={handleChange}
                    />
                  </Grid>
                </Grid>
              </Box>
            ...
            {role === 'staff' && (
              <Box>
                ...
                <Grid container spacing={2}>
                  <Grid item xs={12}>
                    <TextField
                      fullWidth label="Hospital Name" name="staffHospitalName"
            ...
            <Button
              ...
              sx={{
                mt: 5, py: 2, borderRadius: 3, fontWeight: 800,
                bgcolor: '#0062ff', '&:hover': { bgcolor: '#0051d5' }
              }}
            >
